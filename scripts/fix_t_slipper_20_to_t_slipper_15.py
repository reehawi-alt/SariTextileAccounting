"""
Repoint T-SLIPPER(20) to T-SLIPPER(15) per market (purchases, batches, sales, adjustments).

Runs for every market where both catalog lines exist and supplier_id matches.

Usage:
  python scripts/fix_t_slipper_20_to_t_slipper_15.py
"""
import os
import sys
...
OLD_CODE = "T-SLIPPER(20)"
NEW_CODE = "T-SLIPPER(15)"
...
def main():
    with app.app_context():
        ...
        for old_item in olds:
            m = Market.query.get(old_item.market_id)
