"""
Merge WOMEN SHOES(25) into WOMEN SHOES NO.3(25) (TANZANYA YASSER).

Moves purchase_items, inventory_batches, sale_items; deletes duplicate item.

Usage:
  python scripts/fix_women_shoes_duplicate_item.py
"""
import os
import sys
...
OLD_CODE = "WOMEN SHOES(25)"
NEW_CODE = "WOMEN SHOES NO.3(25)"
