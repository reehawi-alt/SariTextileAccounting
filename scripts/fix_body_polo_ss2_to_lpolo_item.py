"""
Merge BODY & L.POLO S/S #2(40) into L.POLO S/S #2(40) (TANZANYA YASSER).

Moves purchase_items, inventory_batches, sale_items; deletes duplicate.

Usage:
  python scripts/fix_body_polo_ss2_to_lpolo_item.py
"""
import os
import sys
...
OLD_CODE = "BODY & L.POLO S/S #2(40)"
NEW_CODE = "L.POLO S/S #2(40)"
